...
export const PlasmicPageDesignSystems__VariantProps = new Array();

export const PlasmicPageDesignSystems__ArgProps = new Array();
        ...
        <SmallValuePropCard
          ...
          followupLink={
            <Linky
              ...
              link={"https://studio.plasmic.app/?starters=general,site-builder"}
              style={["noPadding"]}
            >
              <div
                className={classNames(
